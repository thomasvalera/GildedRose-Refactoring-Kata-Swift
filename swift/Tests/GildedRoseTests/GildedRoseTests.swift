...
class GildedRoseTests: XCTestCase {
    ...
    func testUpdateQuality() {
        let tests: [(item: Item, sellIn: Int, quality: Int)] = [
            ...
            (Item(name: "Standard last day", sellIn: 1, quality: 20), 0, 19),
            (Item(name: "Standard at sellIn", sellIn: 0, quality: 20), -1, 18),
            (Item(name: "Standard past sellIn", sellIn: -3, quality: 20), -4, 18),
            (Item(name: "Standard zero quality", sellIn: -3, quality: 0), -4, 0),
